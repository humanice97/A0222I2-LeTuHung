...
insert into Class(name) values("Le Tu Hung1");
insert into Class(name) values("Le Tu Hung2");
insert into Class(name) values("Le Tu Hung3");
insert into Class(name) values("Le Tu Hung4");
